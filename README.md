...
At the current stage, that path is not membership.
It is a narrower public path for:
...
- [Mirror Guide](./deliverables/How-to-Mirror-AIR-Witness-Pack-v1.md)
- [Mirror Receipt Submission Guide](./deliverables/How-to-Submit-AIR-Mirror-Receipt-v1.md)
